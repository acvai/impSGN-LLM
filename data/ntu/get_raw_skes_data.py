...
if __name__ == '__main__':
    ...
    #### just to check:
    # print("skes_path: ", skes_path)
    # print("stat_path: ", stat_path)
    # print("skes_name_file: ", skes_name_file)
    # print("save_data_pkl: ", save_data_pkl)
    # print("frames_drop_pkl", frames_drop_pkl)
    # assert False, "aaaaaaaaaaaaaaaa"
